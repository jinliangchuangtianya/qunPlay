module.exports = function () {
  ...
  this.encode = function (o) {
    ...
    for (var e, a, n, h, C, d, c = "", i = 0, f = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); i < f.length;) e = r.indexOf(f.charAt(i++)) << 2 | (h = r.indexOf(f.charAt(i++))) >> 4,
      a = (15 & h) << 4 | (C = r.indexOf(f.charAt(i++))) >> 2, n = (3 & C) << 6 | (d = r.indexOf(f.charAt(i++))),
